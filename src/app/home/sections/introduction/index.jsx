        ...
        <div className="flex flex-col justify-around items-center h-full lg:grid lg:grid-cols-2 ">
          <div className="flex flex-col justify-around items-center h-full">
            <div className="flex flex-row ">
              <h1 data-aos="fade-right" className="text-xl lg:text-6xl">Virtus</h1>
              <span data-aos="fade-left" className="text-bluelight text-xl lg:text-6xl">DEV</span>
            </div>
            <p data-aos="fade-up"className="mx-10 my-4 text-sm lg:px-40 lg:border-x lg:border-x-blue4/50 sm:text-xs sm:py-10">
            ...
            <div data-aos="fade-up" className="border border-bluedark h-10 w-40 contain flex items-center justify-center contain-v1 ">
              <Link
          ...
          <div className="h-full py-10 lg:justify-center lg:items-center lg:flex">
            <Image data-aos="fade-left" src="/images/VirtusDev-Bleu.png" width={300} height={300} />
          </div>
        </div>
      </section>
    </>
